...
const projects = [
  {
    ...
    description:
      "We partnered with HashPay to revolutionize their digital payment infrastructure using Hedra Hashgraph. The project focused on creating a secure, high-speed transaction platform that processes micro-transactions with finality, reducing latency and ensuring a seamless payment experience for users.",
  ...
  },
  {
    ...
    description:
      "Our collaboration with SupplyTrust empowered their supply chain management system with immutable, transparent records. Using Hedra's distributed ledger, we ensured real-time tracking of goods, streamlined auditing processes, and minimized fraudulent activities across the supply network.",
  ...
  },
  {
    ...
    description:
      "We developed a decentralized voting platform, DeVote, utilizing Hedra Hashgraph's secure and fair consensus algorithm. The platform offers transparent vote counting, immutable logs, and user anonymity, establishing trust in democratic processes and corporate elections.",
    ...
    <section className="bg-[#A8B2E7] py-24">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-16">
          ...
          <Link
            href="/work"
            className="hidden md:flex items-center gap-2 text-black hover:text-gray-800 transition-colors px-4 py-2 rounded"
          >
