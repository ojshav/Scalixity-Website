...
export function CTA() {
  ...
  Let&rsquo;s discuss how we can help you leverage the power of generative AI and blockchain technology to drive growth and innovation.
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-black text-white-700 font-bold text-lg hover:bg-gray-100 transition-colors"
        >
