        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {Object.entries(techStack).map(([category, items], index) => (
            <motion.div
              ...
              className="rounded-xl border-2 border-black p-6 bg-[#F3F1EB] flex flex-col items-center justify-center"
            >
              <h3 className="text-lg font-semibold mb-6 text-center">{category}</h3>
