...
export function ServiceHero({
  ...
  return (
    <section ref={containerRef} className="bg-[#FFF2D5] h-full lg:h-full lg:min-h-screen flex flex-col items-center justify-center overflow-hidden pt-14 lg:pt-28 lg:pb-20">
