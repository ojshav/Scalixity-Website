...
export function Hero() {
  return (
    <section className="bg-gradient-to-r from-[#5b0bb5] to-[#8e44ad] text-white py-24 relative overflow-hidden">
      ...
      >
        <Image 
          src="/hybrid-app-illustration.png" 
          alt="Hybrid App Development Illustration" 
          width={800} 
          height={400} 
          className="mx-auto"
        />
