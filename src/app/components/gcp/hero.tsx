      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-red-600 text-white font-medium text-lg hover:bg-red-700 transition-colors"
            >
              Contact us
            </Link>
          </motion.div>
