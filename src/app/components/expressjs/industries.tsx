      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-black mt-4 mb-6">
            Express.js Solutions for Diverse Industries
          </h2>
          <p className="text-xl text-black max-w-3xl mx-auto">
            Powering businesses with lightweight, fast, and flexible Express.js applications tailored to industry-specific demands.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {industries.map((industry, index) => (
            ...
            >
              <div className="bg-[#F3F1EB] p-6 rounded-full border border-black mb-4">
                <Image
                  src={industry.icon}
                  alt={industry.name}
                  width={48}
