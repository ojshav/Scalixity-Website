...
const expertiseAreas = [
  ...
  },
  {
    ...
    description: "We develop Natural Language Processing (NLP) applications that assess structured and semistructured content, including search queries, mined web data, business data repositories, and audio sources, to identify emerging patterns, deliver operational insights, and do predictive analytics."
  },
  {
