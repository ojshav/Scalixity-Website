...
const faqs = [
  ...
  {
    question:
      "How do you ensure the security and privacy of our data when developing Generative AI solutions?",
    answer:
      "We take data security and privacy very seriously. Our approach includes implementing robust encryption methods, secure data handling practices, and adherence to industry standards and regulations such as GDPR, HIPAA, and CCPA. We also offer on-premises deployment options for clients with strict data security requirements.",
  },
  {
    question:
      "Can Generative AI solutions be integrated with our existing systems and workflows?",
    answer:
      "Yes, our Generative AI solutions are designed to integrate seamlessly with your existing systems and workflows. We use APIs, microservices, and other integration methods to ensure our solutions work harmoniously with your current infrastructure, minimizing disruption to your operations while maximizing the benefits of AI technology.",
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Find answers to common questions about our Generative AI consulting
            services
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            ...
            >
              <button
                className="flex justify-between items-center w-full text-left p-4 bg-[#F3F1EB] border-2 border-black rounded-lg hover:bg-[#e4ded4] transition-colors"
