    ...
    <section className="bg-[#590178] py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-sm text-white uppercase tracking-wider">RETAIL AI SOLUTIONS</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {applications.map((app, index) => (
            <motion.div
              ...
              className="bg-[#F5F5DC] p-8 rounded-xl border border-black hover:border-black transition-colors"
            >
