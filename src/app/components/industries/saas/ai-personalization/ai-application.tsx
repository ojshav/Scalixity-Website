    ...
    <section className="bg-gradient-to-r from-[#5B1DAF] to-[#8E44AD] text-white py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-sm uppercase tracking-wider text-white/80">AI APPLICATIONS FOR SAAS PERSONALIZATION</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {applications.map((app, index) => (
            ...
            >
              ...
              <p className="text-[#5B1DAF]/80">{app.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
