...
const techStack = [
  ...
  {
    category: "Chatbot Frameworks",
    items: [
      { name: "Rasa", logo: "/images/tech/rasa.svg" },
      { name: "Dialogflow", logo: "/images/tech/dialogflow.svg" },
      { name: "Microsoft Bot Framework", logo: "/images/tech/botframework.svg" }
    ]
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black mt-4 mb-6">
            AI Tech Stack for SaaS Chatbots
          </h2>
          <p className="text-xl text-black max-w-3xl mx-auto">
            Empower your SaaS platform with cutting-edge AI chatbot technologies, combining NLP, AI models, and cloud integrations.
          </p>
        </div>
