...
const techStack = [
  ...
  },
  {
    ...
    items: [
      { name: "Apache Airflow", logo: "/images/tech/spark.svg" },
      { name: "UiPath", logo: "/images/tech/uipath.svg" },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
            AI Tech Stack for SaaS Automation
          </h2>
          <p className="text-xl text-white max-w-3xl mx-auto">
            Leveraging advanced AI, automation, and cloud technologies to streamline SaaS workflows and maximize efficiency.
          </p>
        </div>
