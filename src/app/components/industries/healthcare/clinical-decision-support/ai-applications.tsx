...
import { AlertCircle, BarChart, CheckCircle } from "lucide-react";
...
const clinicalSupportFeatures = [
  {
    ...
    description:
      "AI processes patient data instantly, identifying patterns and predicting health risks.",
  },
  {
    icon: CheckCircle,
    title: "Evidence-Based Recommendations",
    description:
      "Delivers treatment suggestions based on the latest medical research and guidelines.",
  },
  {
    icon: AlertCircle,
    title: "Risk Assessment & Alerts",
    description:
      "Detects early warning signs and alerts clinicians to potential complications.",
  },
];
