      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black mt-4 mb-6">
            Clinical Decision Support Tech Stack
          </h2>
          <p className="text-xl text-black/80 max-w-3xl mx-auto">
            Harness cutting-edge AI frameworks, healthcare data standards, and cloud technologies to power accurate and reliable clinical decision support systems.
          </p>
        </div>
