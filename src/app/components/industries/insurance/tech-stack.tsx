  ...
  return (
    <section className="bg-[#A8B2E7] py-24"> {/* Updated background color */}
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-5xl font-bold text-black mb-12 font-[YourRegularFont]">AI Tech Stack in Insurance</h2> {/* Updated font color and font family */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {techStack.map((tech, index) => (
            ...
            >
              <h3 className="text-2xl font-bold text-black mb-4 font-[YourRegularFont]">{tech.title}</h3> {/* Updated font family */}
              <p className="text-black leading-relaxed font-[YourRegularFont]">{tech.description}</p> {/* Updated font family */}
            </motion.div>
          ))}
        </div>
      </div>
