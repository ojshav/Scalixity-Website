...
const successStories = [
  {
    ...
    description:
      "Developed a robust enterprise application leveraging microservices architecture, enhancing system reliability and efficiency for large-scale operations.",
  ...
  },
  {
    ...
    description:
      "Engineered a secure and AI-driven enterprise financial platform, optimizing compliance and risk management for global transactions.",
    image: "/placeholder.svg?height=400&width=600",
    results: [
