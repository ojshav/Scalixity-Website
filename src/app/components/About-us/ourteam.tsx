    ...
    return (
        <section ref={sectionRef} className={`w-full py-8 sm:py-12 md:py-16 lg:py-20 bg-[#FFF2D5] overflow-hidden relative ${isMobile ? 'min-h-auto' : 'min-h-screen'}`}>
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className={`${!isMobile ? 'absolute left-1/2 -translate-x-1/2' : 'relative w-full'}`}>
                    <div
                        ref={leadershipContainerRef}
                        className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-end mb-8 sm:mb-12 md:mb-16"
                    >
                ...
                {/* Team Members Row */}
                <div className={`${!isMobile ? 'absolute left-1/2 -translate-x-1/2 top-[120px] sm:top-[180px] lg:top-[200px]' : 'relative mt-8 w-full'}`}>
                    <div
                        ref={teamContainerRef}
                        className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-center"
                    >
                        {/* First Row - 2 Cards */}
