    ...
    <section className="bg-[#A8B2E7] py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-black mt-4 mb-6">Frequently Asked Questions</h2>
        ...
        <div className="max-w-3xl mx-auto">
          {faqs.map((faq, index) => (
            ...
            >
              <button
                className="flex justify-between items-center w-full text-left p-4 bg-[#F3F1EB] rounded-lg border border-[#3D3D3D]"
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="p-4 bg-[#F3F1EB] mt-1 rounded-lg border border-[#3D3D3D]">
